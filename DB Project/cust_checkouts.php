...
$next_page = $page_no + 1;
$adjacents = "2";
$result_count = mysqli_query($link, "SELECT COUNT(*) AS total_records FROM checkouts, books3 WHERE cust_id = {$_SESSION['id']} and checkouts.isbn = books3.isbn");
...
<div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="cust_checkouts.php">Checkouts</a></li>
    </ul>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    ...
                    $sql = "SELECT * FROM checkouts, books3 WHERE cust_id = {$_SESSION['id']} and checkouts.isbn = books3.isbn LIMIT $offset, $total_records_per_page";
                            ...
                            echo '<table class="table table-bordered table-striped">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>" . $row['time'] . "</td>";
																				echo "<td>" . date('Y-m-d', strtotime($row['time']. ' + 2 weeks')) . "</td>";
